...
I introduced a pragmatic principle: *if you touch it, you fix it*. This approach kept momentum while ensuring technical debt was addressed gradually. I worked closely with the tech leads to review the architecture and plan staged improvements, ensuring each change aligned with a clear business outcome.
