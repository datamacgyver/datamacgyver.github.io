...
const config: Config = {
  ...
  //   TODO: Make this twelvefive.co.uk
  url: 'https://datamacgyver.github.io',
  ...
  themeConfig: {
    ...
    image: 'img/Twelvefive_white_vector.svg',
    colorMode: {
      defaultMode: 'dark',
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} TwelveFive UK Ltd. Built with Docusaurus.`,
    },
    prism: {
